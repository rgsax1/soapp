                ...
                <tbody>
                    {equipmentGenerals.map((equipmentGeneral) => (
                        <tr key={equipmentGeneral.id}>
                            ...
                            <td>
                                <button className="btn btn-info" onClick={() => updateEquipmentGeneral(equipmentGeneral.id)}>
                                    Atualizar
                                </button>
                                <button className="btn btn-danger" onClick={() => removeEquipmentGeneral(equipmentGeneral.id)} style={{ marginLeft: '10px' }}>
                                    Deletar
                                </button>
                            </td>
                        </tr>
